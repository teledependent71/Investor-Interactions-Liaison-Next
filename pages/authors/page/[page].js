...
import authorsPageInitialPaths442ddResource from '../../../resources/authors-page-initial-paths-442dd'
import authorsPageInitialProps10621Resource from '../../../resources/authors-page-initial-props-10621'
...
export async function getStaticPaths() {
  const response = await authorsPageInitialPaths442ddResource({})
...
export async function getStaticProps(context) {
  const response = await authorsPageInitialProps10621Resource({
    ...context?.params,
